...
export default function PostAdder() {
  ...
  const handleAddPost = async (e) => {
    ...
    try {
      const response = await apiConnector('POST', notesEndpoints.CREATE_NOTE, formData);
  ...
  return (
    <>
      <motion.div
        className={`w-full h-full p-10 cont font-poppins ${darkMode ? "bg-gray-900 text-white" : "bg-white text-black"
          }`}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <motion.div
          className={`w-full h-full p-10 rounded-lg shadow-lg ${darkMode ? "bg-gray-800" : "bg-white"
            }`}
          initial={{ scale: 0.9 }}
          animate={{ scale: 1 }}
        ...
        >
          ...
          >
            <div className="flex flex-col">
              ...
              <input
                ...
                id="title"
                name="title"
                className={`p-2 mt-2 border rounded-lg ${darkMode
          ...
          <div className="mt-5">
            ...
            <motion.div
              className={`p-5 mt-5 rounded-lg ${darkMode ? "bg-gray-700" : "bg-gray-100"
                }`}
